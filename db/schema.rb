...
ActiveRecord::Schema[7.0].define(version: 2023_04_15_044100) do
  ...
  create_table "actions", force: :cascade do |t|
    ...
    t.index ["trade_id"], name: "index_actions_on_trade_id"
    t.index ["trader_id"], name: "index_actions_on_trader_id"
  end
  ...
  create_table "trades", force: :cascade do |t|
    ...
    t.integer "pnl_percentage"
    t.float "pnl"
    t.integer "current_pnl_percentage"
    t.float "size"
    t.float "collateral"
    t.float "size_delta"
    t.float "collateral_delta"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "allocations", array: true
  end
